...
from rlinf.models.embodiment.openpi.dataconfig.libero_dataconfig import (
    LeRobotLiberoDataConfig, LeRobotLiberoIRLDataConfig
)
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_libero_object_rl_irl_positive",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=1, discrete_state_input=False
        ),
        data=LeRobotLiberoDataConfig(
    ...
    TrainConfig(
        name="pi05_libero_object_rl_irl_negative",
        model=pi0_config.Pi0Config(
            pi05=True, action_horizon=1, discrete_state_input=False
        ),
        data=LeRobotLiberoDataConfig(
            repo_id="BBBBBBob/libero_object_negative",
            base_config=DataConfig(prompt_from_task=True),
            assets=AssetsConfig(assets_dir="checkpoints/torch/pi0_libero/assets"),
            extra_delta_transform=False,
        ),
