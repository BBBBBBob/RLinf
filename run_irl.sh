...
#SBATCH --nodelist=507-13
#SBATCH --reservation=j84403411
...
source openpi_irl_venv/bin/activate
...
bash examples/embodiment/run_embodiment_irl.sh libero_object_ppo_openpi_pi05_irl_minimum
